...
| [k01-agent-loop.md](./k01-agent-loop.md) | **0.2.1** | 未开工 | Loop / 错误码 / Turn 接线（别名 K01） |

后续：`k02-tools.md`（**0.2.2**）、`k03-memory.md`（**0.2.3**）… 开工时再建；v0.3 开工前再写 `n01-topology.md` 等。未建计划 = 不授权提前做。
